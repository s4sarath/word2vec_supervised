...
class Word2Vec_Supervised(utils.SaveLoad):
    ...
    def __init__(self, sentences=None, size=100, alpha=0.025, window=5, min_count=5,
        ...
        cbow_mean=0, hashfxn=hash, iter=1, label_dict = {}):
        """
    ...
    def _get_job_words(self, alpha, work, job, neu1):
        if self.sg:
            ...
            # a2 = sum(train_sentence_sg(self, sentence, alpha, work) for sentence in job)
            # a3 = sum(train_sentence_sg_categ(self, sentence, alpha, work) for sentence in job)
            return a1
        else:
